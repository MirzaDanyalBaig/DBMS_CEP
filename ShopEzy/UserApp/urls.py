...
urlpatterns = [
    ...
    path("products_garments", views.products_garments, name="ShopEzy - Shopping Made Easier"),
    path("products_groceries", views.products_groceries, name="ShopEzy - Shopping Made Easier"),
